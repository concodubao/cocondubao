...
export default function Home() {
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-[#f8f9ff] max-w-[480px] mx-auto">
      ...
      {!isFarmer && (
        <main className="flex-1 flex flex-col gap-3 px-5 py-6">
          <p className="text-[13px] text-[#6e7b6c] font-semibold uppercase tracking-wider">
            Truy cập nhanh
          </p>
          ...
          {user?.role === 'engineer' && (
            <button
              ...
              className="flex items-center gap-4 bg-white border border-[#e5eeff] rounded-3xl px-5 py-4
                         shadow-sm active:scale-[0.98] transition-transform text-left"
            >
              <div className="w-12 h-12 rounded-2xl bg-[#f0fdf4] flex items-center justify-center flex-shrink-0">
                <span className="material-symbols-outlined text-[26px] text-[#006b2c]">assignment</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-[17px] font-bold text-[#0b1c30]">Hàng đợi câu hỏi</div>
                <div className="text-[13px] text-[#6e7b6c] mt-0.5">Xem và trả lời câu hỏi từ nông dân</div>
              </div>
          ...
          {user?.role === 'engineer' && (
            <button
              onClick={() => navigate('/engineer/knowledge')}
              className="flex items-center gap-4 bg-white border border-[#e5eeff] rounded-3xl px-5 py-4
                         shadow-sm active:scale-[0.98] transition-transform text-left"
            >
              <div className="w-12 h-12 rounded-2xl bg-[#e5eeff] flex items-center justify-center flex-shrink-0">
                <span className="material-symbols-outlined text-[26px] text-[#00628d]">menu_book</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-[17px] font-bold text-[#0b1c30]">Kiến thức AI</div>
                <div className="text-[13px] text-[#6e7b6c] mt-0.5">Quản lý tài liệu và cơ sở kiến thức</div>
              </div>
              <span className="material-symbols-outlined text-[20px] text-[#bdcaba]">chevron_right</span>
            </button>
          )}
          ...
          {user?.role === 'admin' && (
            ...
            >
              <div className="w-12 h-12 rounded-2xl bg-[#f0fdf4] flex items-center justify-center flex-shrink-0">
                <span className="material-symbols-outlined text-[26px] text-[#006b2c]">bar_chart</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-[17px] font-bold text-[#0b1c30]">Dashboard quản trị</div>
                <div className="text-[13px] text-[#6e7b6c] mt-0.5">Thống kê và quản lý hệ thống</div>
              </div>
              <span className="material-symbols-outlined text-[20px] text-[#bdcaba]">chevron_right</span>
            </button>
          )}
          ...
          {user?.role === 'admin' && (
            ...
            >
              <div className="w-12 h-12 rounded-2xl bg-[#e5eeff] flex items-center justify-center flex-shrink-0">
                <span className="material-symbols-outlined text-[26px] text-[#00628d]">group</span>
              </div>
              <div className="flex-1 min-w-0">
                <div className="text-[17px] font-bold text-[#0b1c30]">Quản lý người dùng</div>
                <div className="text-[13px] text-[#6e7b6c] mt-0.5">Xem và phân quyền tài khoản</div>
              </div>
              <span className="material-symbols-outlined text-[20px] text-[#bdcaba]">chevron_right</span>
            </button>
          )}
