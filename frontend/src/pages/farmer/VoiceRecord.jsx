...
function MicButton({ isListening, isProcessing, onStart, onStop }) {
  ...
  else { bg = '#16a34a'; icon = <Mic size={48} color="#fff" strokeWidth={1.5} />; label = 'Nhấn để nói' }
...
const styles = {
  ...
  btnConfirm:     { flex: 2, padding: '14px', fontSize: 17, background: '#16a34a', color: '#fff', border: 'none', borderRadius: 14, cursor: 'pointer', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 },
