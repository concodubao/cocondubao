...
const s = {
  ...
  sTitle:    { fontSize: 14, fontWeight: 700, color: '#0f172a', margin: 0 },
  typeRow:   { display: 'flex', alignItems: 'center', gap: 12, padding: '6px 0', borderBottom: '1px solid #f1f5f9', cursor: 'pointer' },
  timeInput: { padding: '10px 12px', fontSize: 16, borderRadius: 8, border: '1.5px solid #e2e8f0', outline: 'none', color: '#0f172a', width: '100%', boxSizing: 'border-box', marginTop: 4 },
  btnOn:     { padding: '7px 16px', background: '#16a34a', color: '#fff', border: 'none', borderRadius: 8, cursor: 'pointer', fontSize: 14, fontWeight: 700, whiteSpace: 'nowrap' },
  btnOff:    { padding: '7px 16px', background: 'transparent', color: '#ef4444', border: '1px solid #fecaca', borderRadius: 8, cursor: 'pointer', fontSize: 14, fontWeight: 600, whiteSpace: 'nowrap' },
