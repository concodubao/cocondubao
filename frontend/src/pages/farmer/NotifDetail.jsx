...
const styles = {
  ...
  title:     { fontSize: 'calc(22px * var(--read-scale, 1))', fontWeight: 800, color: '#0f172a', margin: 0, lineHeight: 1.3 },
  date:      { fontSize: 13, color: '#64748b' },
  body:      { fontSize: 'calc(16px * var(--read-scale, 1))', color: '#0f172a', lineHeight: 1.7 },
