...
const styles = {
  ...
  inputBar:        { padding: '10px 12px', background: '#fff', borderTop: '1px solid #e2e8f0', position: 'sticky', bottom: 0 },
  inputRow:        { display: 'flex', gap: 8, alignItems: 'flex-end' },
  textarea:        { flex: 1, padding: '11px 13px', fontSize: 16, borderRadius: 12, border: '1.5px solid #e2e8f0', resize: 'none', outline: 'none', background: '#f8fafc', color: '#0f172a', lineHeight: 1.5, maxHeight: 120 },
