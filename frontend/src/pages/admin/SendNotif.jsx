        ...
        <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
          <div style={{ width: 64, height: 64, borderRadius: '50%', background: result.scheduled ? '#fffbeb' : '#fdf6f0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {result.scheduled
              ...
              : <CheckCircle size={32} color="#4B230A" strokeWidth={1.5} />}
          </div>
...
const s = {
  ...
  btnPrimary:  { padding: '14px', fontSize: 16, fontWeight: 700, background: '#4B230A', color: '#fff', border: 'none', borderRadius: 12, cursor: 'pointer', minHeight: 52 },
  btnSecondary:{ padding: '11px 20px', fontSize: 14, background: 'transparent', color: '#4B230A', border: '1.5px solid #f5d5b0', borderRadius: 10, cursor: 'pointer' },
}
